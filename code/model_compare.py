...
class ModelCompare(baseclass.BaseClass):
    ...
    def print_data(self):
        ...
        for i in range(lines):
            ...
            print(index.format("top 3: ") + general.format(*map(lambda x : str(math.round(x,2)) + "%",batch_top_3)))
            print(index.format("top 5: ") + general.format(*map(lambda x : str(math.round(x,2)) + "%",batch_top_5)))
