...
class ModelCompare(baseclass.BaseClass):
    ...
    def print_data(self):
        ...
        for i in range(lines):
            ...
            print(index.format("precision (macro): ") + general.format(*self._mark_max_val(self.macro_precision_max,batch_macro_precision)))
            print(index.format("(w)") + general.format(*self._mark_max_val(self.weighted_precision_max,batch_weighted_precision)))
            print(index.format("recall (m): ") + general.format(*self._mark_max_val(self.macro_recall_max,batch_macro_recall)))
            print(index.format(" (w)") + general.format(*self._mark_max_val(self.weighted_recall_max,batch_weighted_recall)))
            print(index.format("f1 (m): ") + general.format(*self._mark_max_val(self.macro_f1_max,batch_macro_f1)))
            print(index.format(" (we)") + general.format(*self._mark_max_val(self.weighted_f1_max,batch_weighted_f1)))
